...
import { registrer, loggInnMedGoogle } from '../actions'

const initialState = { feil: '' }

export function RegistrerForm() {
  const [state, action, pending] = useActionState(registrer, initialState)

  return (
    <form action={action} className="flex flex-col gap-4">
      <div className="mb-2">
        <h1 className="text-foreground text-2xl font-semibold tracking-tight">Opprett konto</h1>
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="navn" className="text-foreground text-sm font-medium">
          Navn
        </label>
        <input
          id="navn"
