...
export const PlaceCard = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'bg-card text-card-foreground w-full max-w-sm cursor-pointer overflow-hidden rounded-2xl border shadow-lg',
        className
      )}
    >
      {/* Image Carousel */}
      <div className="group relative h-64">
        ...
        <div className="absolute top-3 right-3">
          <Badge
            variant="secondary"
            className="bg-background/70 flex items-center gap-1 backdrop-blur-sm"
          >
